...
mixin _$Station {
  ...
  String get status =>
      throw _privateConstructorUsedError; // critical, warning, normal, above_normal
...
class _$StationImpl implements _Station {
  ...
  @override
  final String status;
// critical, warning, normal, above_normal
  @override
  ...
  @override
  String toString() {
    return 'Station(id: $id, name: $name, code: $code, latitude: $latitude, longitude: $longitude, state: $state, district: $district, basin: $basin, status: $status, lastUpdatedAt: $lastUpdatedAt, latestWaterLevel: $latestWaterLevel)';
  }
...
abstract class _Station implements Station {
  const factory _Station(
      ...
      required final double latestWaterLevel}) = _$StationImpl;
  ...
  String? get basin;
  @override
  String get status; // critical, warning, normal, above_normal
  @override
